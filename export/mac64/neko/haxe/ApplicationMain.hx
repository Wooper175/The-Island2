...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "The Island", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "The Island";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "The Island", null, { width: 640, height: 480 });
