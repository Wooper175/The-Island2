...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/endeligt.oel", "assets/endeligt.oel");
			type.set ("assets/endeligt.oel", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/images/cave01.png", "assets/images/cave01.png");
			type.set ("assets/images/cave01.png", Reflect.field (AssetType, "image".toUpperCase ()));
